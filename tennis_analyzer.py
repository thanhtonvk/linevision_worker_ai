...
class TennisAnalyzer:
    ...
    def analyze_tennis_match(self, video_path, ball_conf=0.7, person_conf=0.6, 
        ...
        # 8. Tạo báo cáo
        self._print_analysis_report(technique_analysis, person_stats, direction_flags, ball_positions, frames, fps)
    ...
    def _print_analysis_report(self, technique_analysis, person_stats, direction_flags, ball_positions, frames, fps):
    ...
    def create_visualizations(self, results, output_prefix="tennis_analysis"):
        ...
        self.visualizer.create_detailed_technique_report(
            person_tracker, 
            technique_analysis, 
            f"{output_prefix}_detailed_report.txt"
        )
        
        print(f"\n✅ HOÀN THÀNH TẠO VISUALIZATION!")
        print("📁 Các file đã tạo:")
        print(f"  - {output_prefix}_pose_analysis.mp4 (video với pose tracking)")
        print(f"  - {output_prefix}_technique_analysis.png (biểu đồ phân tích kỹ thuật)")
